...
public class TwttrClient extends OAuthBaseClient {
    ...
    public static final String REST_CONSUMER_KEY = "fjzW8u4XxQC2oj973r7m2oYhK";       // Change this
    public static final String REST_CONSUMER_SECRET = "T0anSzwnOjNX2KP6Xw7D5EhhWvewfVQKmMtdgP2qvoZkTDdJd6"; // Change this
