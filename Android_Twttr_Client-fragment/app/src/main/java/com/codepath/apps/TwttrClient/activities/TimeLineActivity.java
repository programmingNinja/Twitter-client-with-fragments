package com.codepath.apps.TwttrClient.activities;
...
import com.codepath.apps.TwttrClient.TweetComposeDialog;
import com.codepath.apps.TwttrClient.TweetComposeDialogListener;
...
public class TimeLineActivity extends AppCompatActivity implements TweetComposeDialogListener {
    ...
    public void onProfileView (View view)
    {
        ...
        Log.d("Rohan", "Screen Name:"+scrName);
